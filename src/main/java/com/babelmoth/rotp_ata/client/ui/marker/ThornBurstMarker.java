...
public class ThornBurstMarker extends MarkerRenderer {

    public ThornBurstMarker(Minecraft mc) {
    ...
    protected boolean shouldRender() {
        ...
        return hud.showExtraActionHud(InitStands.THELA_HUN_GINJEET_THORN_BURST.get());
    }
