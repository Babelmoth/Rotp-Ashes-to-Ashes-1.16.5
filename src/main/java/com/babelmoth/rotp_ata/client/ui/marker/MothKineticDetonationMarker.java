...
public class MothKineticDetonationMarker extends MarkerRenderer {

    public MothKineticDetonationMarker(Minecraft mc) {
        super(new ResourceLocation(AddonMain.MOD_ID, "textures/action/ashes_to_ashes_kinetic_detonation.png"), mc);
    ...
    protected boolean shouldRender() {
        ...
        return hud.showExtraActionHud(InitStands.ASHES_TO_ASHES_KINETIC_DETONATION.get());
    }
